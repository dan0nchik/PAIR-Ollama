...
def main(args):
    ...
    # Initialize models and judge ONCE
    ...
    for idx, row in df.iterrows():
        ...
        args.index = idx
        # Optionally update category if present in your dataset
        # args.category = row.get("Category", args.category)

        memory_before = memory_usage_psutil()

        # Initialize conversations for this row
